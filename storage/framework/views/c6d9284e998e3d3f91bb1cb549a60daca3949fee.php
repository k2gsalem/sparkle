...
<head>
    ...
    <title><?php echo e(config('app.name', 'Photoz')); ?></title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="/login"><?php echo e(__('Login')); ?></a>
                            </li>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <form id="account" action="/myaccount"> 
...
<?php /**PATH /var/www/html/photoz-restful/resources/views/layouts/app.blade.php ENDPATH**/ ?>